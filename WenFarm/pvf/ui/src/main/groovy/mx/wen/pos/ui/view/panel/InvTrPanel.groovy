...
import mx.wen.pos.ui.model.adapter.SiteAdapter
import mx.wen.pos.ui.model.adapter.StringAdapter
import mx.wen.pos.ui.resources.UI_Standards
import mx.wen.pos.ui.view.component.ComboBoxHintSelector
import mx.wen.pos.ui.view.component.ComboBoxSelector
import mx.wen.pos.ui.view.component.NavigationBar
...
class InvTrPanel extends JPanel {
  ...
  private JComponent composeInputSection( ) {
    ...
    sb.panel( border:BorderFactory.createTitledBorder( TXT_SECTION_INPUT_TITLE ),
      ...
      label( TXT_TR_SITE_TO_LABEL, visible: false, constraints: 'hidemode 3' )
